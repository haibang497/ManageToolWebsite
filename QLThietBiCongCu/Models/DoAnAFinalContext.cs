...
{
    public partial class DoAnAFinalContext : DbContext
    {
        public DoAnAFinalContext()
        {
        }

        public DoAnAFinalContext(DbContextOptions<DoAnAFinalContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<PerDetail1> PerDetail1 { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=LAPTOP-U81C997K\\SQLEXPRESS; Database=DoAnAFinal; Trusted_Connection=True; MultipleActiveResultSets=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DonVi>(entity =>
            {
                entity.HasKey(e => e.MaDonVi)
                    .HasName("PK__DonVi$__DDA5A6CF137A9DB7");
                ...
                entity.Property(e => e.UserDo).HasMaxLength(50);
            });

            modelBuilder.Entity<DongTb>(entity =>
            {
                entity.HasKey(e => e.IddongTb)
                    .HasName("PK__DongTB$__FE71207E3A505ABF");
            ...
            modelBuilder.Entity<HoaDon>(entity =>
            {
                entity.HasKey(e => e.IdhoaDon)
                    .HasName("PK__HoaDon$__5B896F4912CD274C");
            ...
            modelBuilder.Entity<LoaiTb>(entity =>
            {
                entity.HasKey(e => e.MaLoai)
                    .HasName("PK__LoaiTB$__730A5759E1DDE5F4");
            ...
            modelBuilder.Entity<MaTb>(entity =>
            {
                entity.HasKey(e => e.MaTb1)
                    .HasName("PK__MaTB$__2725006F606B339A");
            ...
            modelBuilder.Entity<NhomKd>(entity =>
            {
                entity.HasKey(e => e.MaNhomKd)
                    .HasName("PK__NhomKD$__5A1F6573E310A8CA");
            ...
            modelBuilder.Entity<NhomTb>(entity =>
            {
                entity.HasKey(e => e.IdnhomTb)
                    .HasName("PK__NhomTB$__7B168B4849020EC3");
            ...
            modelBuilder.Entity<PerDetail1>(entity =>
            {
                ...
                entity.HasOne(d => d.IdPerNavigation)
                    .WithMany(p => p.PerDetail1)
                    .HasForeignKey(d => d.IdPer)
                    .HasConstraintName("FK_PerDetail1_Permission");
            });
            ...
            modelBuilder.Entity<ThongTinKd>(entity =>
            {
                entity.HasKey(e => e.MaKd)
                    .HasName("PK__ThongTin__2725CF02C0C7D317");
